...

{
    ...
    is( Pod::Html::_depod(\$str), 'a bold move', '_depod ref');
}

is( Pod::Html::_fragment_id_obfuscated('@#$'), '%40%23%24',
    'obfuscated fragment id' );

is( Pod::Html::_fragment_id_obfuscated('@#$ab'), '%40%23%24ab',
